...
class SimulatedStore {
  ...
  initMocks() {
    // Migration: if the stored database is using an old format or doesn't have Cupertino data, wipe it so it gets fully re-seeded
    const existingDb = localStorage.getItem("asl_db");
    if (existingDb) {
      try {
        const parsed = JSON.parse(existingDb);
        if (parsed && parsed.posts && parsed.posts.length < 40) {
          localStorage.removeItem("asl_db");
        }
      } catch {
    ...
    const mockUsersList = {
          ...
          "u_steve": { uid: "u_steve", username: "steve_jobs_fan", mood: "Inspired ⚡", bio: "Design is how it works. Cupertino native.", profileTheme: "classic", emoji_avatar: "🖥️💡👓", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 10 * 24 * 60 * 60 * 1000 },
          "u_woz": { uid: "u_woz", username: "woz_legend", mood: "Chillin' 😎", bio: "Building things in my garage. HP calculator collector.", profileTheme: "gameboy", emoji_avatar: "🕹️🔧📻", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 10 * 24 * 60 * 60 * 1000 },
          "u_jony": { uid: "u_jony", username: "aluminum_jony", mood: "Reflective 📖", bio: "Obsessed with CNC milled aluminum and white surfaces.", profileTheme: "classic", emoji_avatar: "📐⚪✨", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 10 * 24 * 60 * 60 * 1000 },
          "u_reviewer": { uid: "u_reviewer", username: "reviewer_appstore", mood: "Busy 🏙️", bio: "Checking metadata, testing guidelines. iPhone developer.", profileTheme: "sunset", emoji_avatar: "📱🧐🍎", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 10 * 24 * 60 * 60 * 1000 },
          "u_wizard": { uid: "u_wizard", username: "code_wizard", mood: "Vibing ✨", bio: "Vim bindings everywhere. Writing compiler code on coffee.", profileTheme: "cyberpunk", emoji_avatar: "💻☕🧙", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 10 * 24 * 60 * 60 * 1000 },
          "u_siri": { uid: "u_siri", username: "siri_whisperer", mood: "Happy 😊", bio: "Speaking to neural nets all day. Whisper secrets to me.", profileTheme: "cyberpunk", emoji_avatar: "🎙️🔮🌌", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_cocoa": { uid: "u_cocoa", username: "cocoa_toucher", mood: "Reflective 📖", bio: "Subclassing NSObject since 2008. Swift is my language.", profileTheme: "classic", emoji_avatar: "🍫📱⌨️", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_swift": { uid: "u_swift", username: "swiftie_dev", mood: "Excited ⚡", bio: "Safety, speed, and expressive syntax. Swift UI advocate.", profileTheme: "sunset", emoji_avatar: "🐦🔥💅", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_glass": { uid: "u_glass", username: "glassmorphic", mood: "Creative 🎨", bio: "If it's not translucent with a backdrop-filter, I don't want it.", profileTheme: "glitter", emoji_avatar: "🔮💎✨", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_infinite": { uid: "u_infinite", username: "infinite_runner", mood: "Happy 😊", bio: "Lapping Infinite Loop at lunch. 5k runner.", profileTheme: "sunset", emoji_avatar: "🏃‍♂️🌀💨", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_espresso": { uid: "u_espresso", username: "double_shot", mood: "Caffeinated ☕", bio: "Caffe Macs bar regular. I know the grind.", profileTheme: "classic", emoji_avatar: "☕⚡☕", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_keynote": { uid: "u_keynote", username: "keynote_master", mood: "Sassy 💅", bio: "Magic Move transition is the cure for boring presentations.", profileTheme: "classic", emoji_avatar: "📊🎬🎩", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_transistor": { uid: "u_transistor", username: "silicon_sally", mood: "Inspired ⚡", bio: "Custom silicon design. Nanometer precision.", profileTheme: "cyberpunk", emoji_avatar: "🔌⚡👩‍💻", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_retail": { uid: "u_retail", username: "genius_barfly", mood: "Tired 😴", bio: "Explaining how iCloud works to grandparents. Beer please.", profileTheme: "classic", emoji_avatar: "🛠️🍎🍺", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_dongle": { uid: "u_dongle", username: "dongle_life", mood: "Mellow 🎧", bio: "USB-C to headphone jack, HDMI, Ethernet, and SD card.", profileTheme: "classic", emoji_avatar: "🔌📦🙃", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_laser": { uid: "u_laser", username: "laser_etcher", mood: "Creative 🎨", bio: "Engraving names on iPad backs. Clean lines only.", profileTheme: "cyberpunk", emoji_avatar: "⚡🔴🎨", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_compiler": { uid: "u_compiler", username: "llvm_coder", mood: "Reflective 📖", bio: "Optimizing ASTs. Zero-cost abstractions are my drug.", profileTheme: "classic", emoji_avatar: "💾🛠️⚙️", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_halo": { uid: "u_halo", username: "halo_ring", mood: "Vibing ✨", bio: "Walking the Apple Park ring. 1.2 miles of spaceship architecture.", profileTheme: "sunset", emoji_avatar: "🪐🔘✨", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_solder": { uid: "u_solder", username: "solder_queen", mood: "Happy 😊", bio: "Lead-free solder, hot air stations, and custom mechanical keyboards.", profileTheme: "gameboy", emoji_avatar: "📻🔥🛠️", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_vision": { uid: "u_vision", username: "spatial_spud", mood: "Dreamy 🌌", bio: "Living in simulated coordinates. Vision Pro dev.", profileTheme: "cyberpunk", emoji_avatar: "🥽👾🌌", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_unboxing": { uid: "u_unboxing", username: "unboxing_asmr", mood: "Excited ⚡", bio: "Peeling the screen plastic off pristine Apple hardware.", profileTheme: "glitter", emoji_avatar: "📦✂️✨", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_vintage": { uid: "u_vintage", username: "vintage_newton", mood: "Nostalgic 📼", bio: "Green screen PDA collector. Handwriting recognition is fine.", profileTheme: "classic", emoji_avatar: "📟📝📂", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_darkmode": { uid: "u_darkmode", username: "dark_mode_only", mood: "Emo 🖤", bio: "RGB 0, 0, 0 is the only acceptable background color.", profileTheme: "cyberpunk", emoji_avatar: "🕶️🖤🌑", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_designer": { uid: "u_designer", username: "pixel_pusher", mood: "Creative 🎨", bio: "Kerning is everything. 1px misalignment keeps me awake.", profileTheme: "sunset", emoji_avatar: "📐🖌️💻", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 },
          "u_corgi": { uid: "u_corgi", username: "campus_corgi", mood: "Friendly 🙂", bio: "Chasing squirrels in Apple Park lawn. Pet me please!", profileTheme: "classic", emoji_avatar: "🐕🐾🌳", favorited_bars: ["venue_cafemacs", "venue_applepark"], homeCity: "Cupertino", selectedCity: "Cupertino", createdAt: Date.now() - 5 * 24 * 60 * 60 * 1000 }
    };
    ...
    if (!localStorage.getItem("asl_db")) {
      const initialDb = {
        ...
        posts: [
          ...
          },
          {
            ...
            venueAddress: "1 Infinite Loop, Cupertino, CA 95014",
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "Saw someone with a classic Macintosh SE/30 T-shirt near the espresso bar. You smiled when I mentioned HyperCard. Next latte is on me?",
            userId: "u_steve",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 4 * 24 * 60 * 60 * 1000,
            status: "connected",
            connectedWithId: "u_wizard",
            connectedWithUsername: "code_wizard",
            connectedProofText: "OMG that was me! I still develop HyperCard stacks. I remember your retro glasses!"
          },
          {
            id: "c_post2",
            venueId: "venue_infiniteloop",
            venueName: "Infinite Loop Lounge",
            venueAddress: "2 Infinite Loop, Cupertino, CA 95014",
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "Had a great conversation about dial-up modems and blue boxes near the bar last night. You had a retro Apple II pins collection. Let's connect!",
            userId: "u_woz",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 4 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueAddress: "10600 N Tantau Ave, Cupertino, CA 95014",
            venueCity: "Cupertino",
            venueZone: "Campus",
            text: "Locked eyes with a designer carrying a vintage translucent Bondi Blue iMac sketch. You were sitting near the olive trees. Let's chat.",
            userId: "u_jony",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 4 * 24 * 60 * 60 * 1000,
            status: "connected",
            connectedWithId: "u_infinite",
            connectedWithUsername: "infinite_runner",
            connectedProofText: "Yes, I was the runner with the blue shoes! Those Stevens Creek sprints are killer. Let's get a drink!"
          },
          {
            id: "c_post4",
            venueId: "venue_duke",
            venueName: "The Duke of Edinburgh",
            venueAddress: "10801 N Wolfe Rd, Cupertino, CA 95014",
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "You were playing darts and hit three bullseyes in a row! I was the guy with the mechanical keyboard. Let's grab another pint of draft ale.",
            userId: "u_wizard",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 4 * 24 * 60 * 60 * 1000,
          ...
          {
            id: "c_post5",
            venueId: "venue_lazydog",
            venueName: "Lazy Dog Restaurant & Bar",
            venueAddress: "19359 Stevens Creek Blvd, Cupertino, CA 95014",
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "To the person with the golden retriever who shared their patio table: let's chat about native iOS guidelines again!",
            userId: "u_reviewer",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 4 * 24 * 60 * 60 * 1000,
            status: "connected",
            connectedWithId: "u_corgi",
            connectedWithUsername: "campus_corgi",
            connectedProofText: "That was my corgi, Barnaby! He loved the attention. Let's definitely talk iOS guidelines over coffee."
          },
          {
            id: "c_post6",
            venueId: "venue_cafemacs",
            ...
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "You were speaking to your phone using voice commands in a British accent, ordering a cortado. I was the developer sitting next to you laughing at the Siri reply. Let's chat.",
            userId: "u_siri",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "You had a green Xcode laptop decal and were debugging a memory leak in Instruments. I offered to help, but got distracted by our coffee delivery. Let's get another drink.",
            userId: "u_cocoa",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Campus",
            text: "Locked eyes at the Visitor Center Cafe. You had a custom orange Swift logo on your tote bag. I wanted to ask what you were building, but you hopped on a shuttle. Find me!",
            userId: "u_swift",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "You were explaining CSS backdrop-filters to a friend over a plate of fish & chips. I was admiring your designer eye from the next table. Let's grab a beer!",
            userId: "u_glass",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "We kept pacing each other on the Stevens Creek running trail, then both ended up at the Lazy Dog bar. You had custom blue running shoes. Let's talk splits.",
            userId: "u_infinite",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            id: "c_post11",
            venueId: "venue_oasis",
            venueName: "The Oasis Cupertino",
            venueAddress: "Stevens Creek Blvd, Cupertino, CA 95014",
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "You ordered a quadruple shot of espresso and drank it straight. Respect. You had black glasses and a retro Apple Park map printed on your shirt. Let's get coffee again.",
            userId: "u_espresso",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "You were fine-tuning a presentation with incredible slide transitions, showing a sleek new hardware concept. I sat next to you looking over. Beautiful work.",
            userId: "u_keynote",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "You were reading a textbook on VLSI chip design and drinking an IPA. I haven't seen anyone read physical engineering books in forever. You looked awesome.",
            userId: "u_transistor",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Campus",
            text: "Blue shirt employee with the kind eyes who helped me reset my Apple Watch. You spent 20 minutes making sure I didn't lose my workout data. Let's get a drink after your shift?",
            userId: "u_retail",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "You lent me your USB-C to USB-A adapter so I could present my demo. I completely forgot to return it to you before leaving! Let me buy you a drink to return it.",
            userId: "u_dongle",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "You had a laser-engraved steel flask and were showing your friends custom typography layout designs. I was sitting at the corner booth watching. Let's connect!",
            userId: "u_laser",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "We argued about LLVM compiler flags vs GCC at the bar. You were incredibly smart and passionate about optimization. I'd love to continue the debate.",
            userId: "u_compiler",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 2 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "You had an Apple Park campus badge and were walking the loop path listening to music. We smiled as we passed each other. Let's walk together sometime.",
            userId: "u_halo",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "You had solder burns on your hands and a beautiful custom split mechanical keyboard on the table. I was the one asking about your keycaps. Let's chat gear.",
            userId: "u_solder",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 1 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Campus",
            text: "You were wearing a spatial computing headset and typing in mid-air. You looked hilarious but also futuristic. I was the one grinning from the bench. Let's meet.",
            userId: "u_vision",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 1 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "You were unboxing a brand new device at the table and the sound of the cardboard peel tab made us both laugh. Let's do an unboxing together.",
            userId: "u_unboxing",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 1 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "You were taking notes on an old Apple Newton message pad! I couldn't believe my eyes. I was the guy with the retro Casio watch who asked about it. Let's chat vintage tech.",
            userId: "u_vintage",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 1 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "Main Street",
            text: "You were wearing a matte black hoodie, typing in a dark theme editor. We locked eyes when the bartender turned on the neon sign. Let's meet in the dark.",
            userId: "u_darkmode",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 1 * 24 * 60 * 60 * 1000,
          ...
          },
          {
            ...
            venueCity: "Cupertino",
            venueZone: "HQ",
            text: "You were sketching layouts on an iPad Pro with a paper-like screen protector. The scratching sound was soothing. You had a great style. Next coffee on me?",
            userId: "u_designer",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 1 * 24 * 60 * 60 * 1000,
            status: "connected",
            connectedWithId: "u_designer",
            connectedWithUsername: "pixel_pusher",
            connectedProofText: "I love drawing layouts on the patio! Thanks for noticing my sketches. Let's get that coffee."
          },
          {
            id: "c_post25",
            venueId: "venue_applepark",
            ...
            venueCity: "Cupertino",
            venueZone: "Campus",
            text: "To the girl who threw the tennis ball for my corgi at the lawn: you had a great laugh and a green backpack. Let's get a coffee and walk the pup again!",
            userId: "u_corgi",
            date: "Jun 3, 2026",
            timeRange: "12:15 PM",
            timestamp: Date.now() - 1 * 24 * 60 * 60 * 1000,
        ...
        connections: {
          ...
          "c_conn_1": { id: "c_conn_1", postId: "c_post1", postText: "Saw someone with a classic Macintosh SE/30 T-shirt near the espresso bar. You smiled when I mentioned HyperCard. Next latte is on me?", venueName: "Caffe Macs", senderId: "u_wizard", receiverId: "u_steve", proofText: "OMG that was me! I still develop HyperCard stacks. I remember your retro glasses!", status: "accepted" },
          "c_conn_2": { id: "c_conn_2", postId: "c_post3", postText: "Had a great conversation about dial-up modems and blue boxes near the bar last night. You had a retro Apple II pins collection. Let's connect!", venueName: "Apple Park Visitor Center Cafe", senderId: "u_woz", receiverId: "u_jony", proofText: "I was sketching the iMac! The Bondi Blue color is timeless. Let's meet up.", status: "pending" },
          "c_conn_3": { id: "c_conn_3", postId: "c_post1", postText: "Saw someone with a classic Macintosh SE/30 T-shirt near the espresso bar. You smiled when I mentioned HyperCard. Next latte is on me?", venueName: "Caffe Macs", senderId: "u_siri", receiverId: "u_steve", proofText: "I was wearing that Macintosh SE/30 shirt! I love HyperCard so much. Let's get that latte!", status: "accepted" },
          "c_conn_4": { id: "c_conn_4", postId: "c_post5", postText: "To the person with the golden retriever who shared their patio table: let's chat about native iOS guidelines again!", venueName: "Lazy Dog Restaurant & Bar", senderId: "u_corgi", receiverId: "u_reviewer", proofText: "That was my corgi, Barnaby! He loved the attention. Let's definitely talk iOS guidelines over coffee.", status: "accepted" },
          "c_conn_5": { id: "c_conn_5", postId: "c_post8", postText: "Locked eyes at the Visitor Center Cafe. You had a custom orange Swift logo on your tote bag. I wanted to ask what you were building, but you hopped on a shuttle. Find me!", venueName: "Apple Park Visitor Center Cafe", senderId: "u_cocoa", receiverId: "u_swift", proofText: "I had that Swift logo bag! I was heading to Cupertino Transit Center. Let's chat Swift UI!", status: "pending" },
          "c_conn_6": { id: "c_conn_6", postId: "c_post3", postText: "Had a great conversation about dial-up modems and blue boxes near the bar last night. You had a retro Apple II pins collection. Let's connect!", venueName: "Apple Park Visitor Center Cafe", senderId: "u_infinite", receiverId: "u_jony", proofText: "Yes, I was the runner with the blue shoes! Those Stevens Creek sprints are killer. Let's get a drink!", status: "accepted" },
          "c_conn_7": { id: "c_conn_7", postId: "c_post6", postText: "You were speaking to your phone using voice commands in a British accent, ordering a cortado. I was the developer sitting next to you laughing at the Siri reply. Let's chat.", venueName: "Caffe Macs", senderId: "u_espresso", receiverId: "u_siri", proofText: "I needed that quad shot for a late release! Let's get espresso.", status: "pending" },
          "c_conn_8": { id: "c_conn_8", postId: "c_post24", postText: "You were sketching layouts on an iPad Pro with a paper-like screen protector. The scratching sound was soothing. You had a great style. Next coffee on me?", venueName: "Caffe Macs", senderId: "u_designer", receiverId: "u_designer", proofText: "I love drawing layouts on the patio! Thanks for noticing my sketches. Let's get that coffee.", status: "accepted" }
        },
        chats: {
          "c_chat_1": { id: "c_chat_1", connectionId: "c_conn_1", participants: ["u_wizard", "u_steve"], lastMessage: "System: Connection accepted. Start chatting!", lastTimestamp: Date.now(), venueName: "Caffe Macs" },
          "c_chat_3": { id: "c_chat_3", connectionId: "c_conn_3", participants: ["u_siri", "u_steve"], lastMessage: "System: Connection accepted. Start chatting!", lastTimestamp: Date.now(), venueName: "Caffe Macs" },
          "c_chat_4": { id: "c_chat_4", connectionId: "c_conn_4", participants: ["u_corgi", "u_reviewer"], lastMessage: "System: Connection accepted. Start chatting!", lastTimestamp: Date.now(), venueName: "Lazy Dog Restaurant & Bar" },
          "c_chat_6": { id: "c_chat_6", connectionId: "c_conn_6", participants: ["u_infinite", "u_jony"], lastMessage: "System: Connection accepted. Start chatting!", lastTimestamp: Date.now(), venueName: "Apple Park Visitor Center Cafe" },
          "c_chat_8": { id: "c_chat_8", connectionId: "c_conn_8", participants: ["u_designer", "u_designer"], lastMessage: "System: Connection accepted. Start chatting!", lastTimestamp: Date.now(), venueName: "Caffe Macs" }
        },
        messages: {},
        blacklisted_devices: {},
        appeals: {}
      ...
      // Merge missing mock data (users, posts, connections, chats) in case the DB was already initialized
      try {
        const dbData = JSON.parse(localStorage.getItem("asl_db") || "{}");
        if (!dbData.users) dbData.users = {};
        if (!dbData.posts) dbData.posts = [];
        if (!dbData.connections) dbData.connections = {};
        if (!dbData.chats) dbData.chats = {};
        if (!dbData.messages) dbData.messages = {};
        if (!dbData.blacklisted_devices) dbData.blacklisted_devices = {};
        if (!dbData.appeals) dbData.appeals = {};
    ...
    const mockAccounts = {
      ...
      "steve.fan@asl.com": { uid: "u_steve", password: "password123" },
      "woz.legend@asl.com": { uid: "u_woz", password: "password123" },
      "jony.al@asl.com": { uid: "u_jony", password: "password123" },
      "appstore.review@asl.com": { uid: "u_reviewer", password: "password123" },
      "wizard.code@asl.com": { uid: "u_wizard", password: "password123" },
      "siri.whisperer@asl.com": { uid: "u_siri", password: "password123" },
      "cocoa.toucher@asl.com": { uid: "u_cocoa", password: "password123" },
      "swiftie.dev@asl.com": { uid: "u_swift", password: "password123" },
      "glassmorphic@asl.com": { uid: "u_glass", password: "password123" },
      "infinite.runner@asl.com": { uid: "u_infinite", password: "password123" },
      "double.shot@asl.com": { uid: "u_espresso", password: "password123" },
      "keynote.master@asl.com": { uid: "u_keynote", password: "password123" },
      "silicon_sally@asl.com": { uid: "u_transistor", password: "password123" },
      "genius.barfly@asl.com": { uid: "u_retail", password: "password123" },
      "dongle_life@asl.com": { uid: "u_dongle", password: "password123" },
      "laser.etcher@asl.com": { uid: "u_laser", password: "password123" },
      "llvm.coder@asl.com": { uid: "u_compiler", password: "password123" },
      "halo.ring@asl.com": { uid: "u_halo", password: "password123" },
      "solder.queen@asl.com": { uid: "u_solder", password: "password123" },
      "spatial.spud@asl.com": { uid: "u_vision", password: "password123" },
      "unboxing.asmr@asl.com": { uid: "u_unboxing", password: "password123" },
      "vintage.newton@asl.com": { uid: "u_vintage", password: "password123" },
      "dark.mode.only@asl.com": { uid: "u_darkmode", password: "password123" },
      "pixel_pusher@asl.com": { uid: "u_designer", password: "password123" },
      "campus_corgi@asl.com": { uid: "u_corgi", password: "password123" }
    };
...
export const dbSubmitReport = async ({ targetUserId, postId, reason }) => {
  ...
  const { getFunctions, httpsCallable } = await import("firebase/functions");
  const fns = getFunctions();
  const fn = httpsCallable(fns, "submitReport");
  const result = await fn({ targetUserId, postId, reason });
  return result.data;
};
