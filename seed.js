...
const MOCK_USERS = [
  ...
  { username: "RetroGamer", mood: "Focused 🎮", bio: "Beating high scores since '95.", emoji_avatar: "🕹️", theme: "pokemon" },
...
async function seed() {
  ...
  // Create 10 posts from the first 10 users
  for (let i = 0; i < 10; i++) {
    ...
    await addDoc(collection(db, "posts"), {
      ...
      text: text,
      timestamp: Date.now() - Math.floor(Math.random() * 86400000 * 5), // within last 5 days
      date: "May 2026",
      timeRange: "Evening",
      status: "active",
